...
# Prod Vercel/Cloud: bake API + WS hosts into client + CSP connect-src
...
ENV NEXT_PUBLIC_COLLAB_DOC_SYNC=$NEXT_PUBLIC_COLLAB_DOC_SYNC
ENV NEXT_PUBLIC_DISABLE_LIVE=$NEXT_PUBLIC_DISABLE_LIVE
