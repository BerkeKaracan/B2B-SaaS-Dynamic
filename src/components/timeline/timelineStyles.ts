...
export const SURFACE = {
  ...
  panel:
    'bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-700 shadow-[0_12px_40px_-12px_rgba(0,0,0,0.14)] rounded-xl',
  toolbarActive:
...
/** Hex + 0–1 alpha → #RRGGBBAA for inline washes */
...
/** Day-lane accent: today = sky, weekend = zinc-slate, weekday = cool zinc */
