...
export default function NotificationBell() {
  ...
  return (
    <div className="relative" ref={popoverRef}>
      ...
      {isOpen && (
        <div className="absolute -right-2 sm:right-0 mt-3 w-[calc(100vw-2rem)] max-w-[320px] sm:max-w-none sm:w-[24rem] bg-white border border-zinc-200 shadow-[0_20px_40px_-15px_rgba(0,0,0,0.1)] rounded-2xl overflow-hidden z-50 animate-in fade-in zoom-in-95 duration-200 origin-top-right">
