...
export const BRAND_TITLE_TEMPLATE = '%s · WORKSPACE OS';
export const BRAND_DESCRIPTION =
  'The operating system for your company. Spatial canvas, real-time sync, enterprise RBAC, and workspace AI — multi-tenant workspace built for teams.';
