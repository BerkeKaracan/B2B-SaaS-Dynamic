...
export default function TermsPage() {
  ...
  return (
    <div className="min-h-screen bg-[#fafafb] dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100 font-sans flex flex-col selection:bg-rose-200 dark:selection:bg-rose-900 transition-colors duration-300">
      <header className="h-16 border-b border-zinc-200/50 dark:border-zinc-800/50 bg-white/70 dark:bg-zinc-950/70 backdrop-blur-xl fixed top-0 w-full z-50 px-6 lg:px-10 flex items-center justify-between transition-colors duration-300">
        ...
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 bg-zinc-950 dark:bg-white rounded-xl flex items-center justify-center shadow-md">
            <span className="text-white dark:text-zinc-950 text-xs font-black font-mono tracking-tighter">
              B2
            </span>
          </div>
          <span className="text-sm font-black text-zinc-950 dark:text-white tracking-tight uppercase">
            SaaS Engine
          </span>
        </div>
      ...
      <main className="flex-1 pt-32 pb-20 px-6 max-w-4xl mx-auto w-full">
        ...
        <div className="bg-rose-50 dark:bg-rose-950/30 border border-rose-200 dark:border-rose-900/50 rounded-2xl p-6 mb-12 flex items-start gap-4 transition-colors duration-300">
          <AlertTriangle className="w-6 h-6 text-rose-600 dark:text-rose-400 shrink-0 mt-0.5" />
          <p className="text-sm font-semibold text-rose-800 dark:text-rose-300 leading-relaxed">
            {t("disclaimer")}
          </p>
        </div>
