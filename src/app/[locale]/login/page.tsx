              ...
              <form className="space-y-5" onSubmit={handleMfaSubmit}>
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    placeholder="123456"
                    className="w-full px-4 py-3.5 bg-zinc-50 border border-zinc-200/80 rounded-2xl text-sm font-semibold tracking-[0.3em] text-center focus:outline-none focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 focus:bg-white transition-all shadow-sm placeholder:text-zinc-400 placeholder:tracking-normal"
                    required
                  />
                </div>
                ...
                <button
                  ...
                  className="w-full text-sm font-semibold text-zinc-500 hover:text-zinc-800 transition-colors"
                >
                  Back to password
                </button>
              </form>
